...
using System.Linq;
using System.Text;
using IbatisLibrary.DataAccess;
using IBatisNet.DataAccess.Interfaces;
using IBatisNet.DataAccess;
using IbatisLibrary.Context;
using IBatisNet.DataAccess.SessionStore;

namespace IbatisLibrary.DataBasic
{
    public class BasicBill<T> where T : class
    {
        #region 私有变量
        ...
        /// 构造器
        /// </summary>
        protected BasicBill(SqlMapContextEnum sqlMapContextEnum)
        {
            try
            {
